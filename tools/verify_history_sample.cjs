...
(async () => {
  ...
  try {
    ...
    await page.evaluate(keys => {
      ...
      if (source.variants.length !== 3) throw Error('Expected three verified variants');
    ...
    console.log('51 source keys, alternate pairs, shared maps, native tables and 153 viewport renders verified.');
