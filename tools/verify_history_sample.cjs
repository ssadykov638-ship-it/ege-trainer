...
(async () => {
  ...
  try {
    ...
    await page.evaluate(keys => {
      ...
      if (source.variants.length !== 2) throw Error('Expected two verified variants');
    ...
    console.log('34 source keys, alternate pairs, shared maps, native tables and 102 viewport renders verified.');
